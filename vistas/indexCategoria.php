...
<script type="text/javascript" src="../js/indexCategoria.js"></script>
<body>
		...
		<div class="row"><!--inicia primera fila-->
			<div class="col-xs-12 col-md-12 col-sm-12 col-sm-12">
				<br><h1 style="text-align: center;">Categorias &nbsp<span class="fas fa-tasks"></span></h1><br>
				<form id="formBusqueda">
					...
					<div class="form-row">
						<div class="form-group col-xs-4 col-sm-4 col-md-4">
							<span class="btn btn-primary"  data-toggle="modal" data-target="#agregarModal" onclick="cargar()">Ingresar Nueva Categoria <span class="fas fa-user-plus"></span>
						</span>
						</div>
					</div>		
				</form>
