			...
			<div class="col-xs-12 col-sm-12 col-md-12 "><!--inicia contenedor del contenido externo-->
				...
				<div class="row"><!--inicia fila que divide la barra lateral con el formulario-->
					<div id="contenedorForm" class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><!--inicia contenedor del formulario-->
						<br><form id="formCategoria" action="../controladores/Categoria.controlador.php?a=edit" method="POST">					
							<div class="form-row">
								<div class="form-group col-md-4">
							    	<br>
							    	<input type="hidden" value="<?=$obj[0]?>" name="idCategoria">
							    ...
							    <div class="form-group col-md-8">
									...
									<input value="<?=$obj[2]?>" maxlength="50" type="text" class="form-control" id="txtNombre" name="nombre">
							...
							<div class="form-row">
							    <div class="form-group col-md-12">
							    	...
							    	<textarea maxlength="150" style="resize: none;" name="descripcion" id="txtDescripcion" class="md-textarea form-control" rows="5"><?=$obj[3]?></textarea>
							...
							<div class="form-row">
								...
								<div style="text-align: center;" class="form-group col-xs-4 col-sm-4 col-md-4">
									<a href="dashboard.php?form=6" class="btn btn-dark">Regresar</a>
								</div>	
							</div>
						</form><br>	
