...
<section>
	...
	<tr>
		...
		<td style="width: 75%; font-size: 28px; font-weight: bold;"><span style="margin-left: 1.5%;">Reporte de Tickets según departamento</span></td>
		<td style="width: 15%; text-align: center;"><b style="font-size: 13px;">'. $fechaLocal . "<br>" . $horaLocal .'</b></td>
	</tr>
	<tr>
		<td style="text-align: left;" colspan="3"><br>Reportes de Tickets cerrados según departamento</td>
	</tr>
	</table><br>
