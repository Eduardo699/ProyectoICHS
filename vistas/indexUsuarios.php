...
<script type="text/javascript" src="../js/indexUsuarios.js"></script>
<body>
		...
		<div class="row"><!--inicia primera fila-->
			<div class="col-xs-12 col-md-12 col-sm-12 col-sm-12">
				<br><h1 style="text-align: center;">Usuarios &nbsp<span class="fas fa-user-plus"></span></h1><br>
				<form id="formBusqueda">
					...
					<div class="form-row">
						<div class="form-group col-xs-4 col-sm-4 col-md-4">
							<span class="btn btn-primary"  data-toggle="modal" data-target="#agregarModal" onclick="cargar()">Ingresar Nuevo Usuario <span class="fas fa-user-plus"></span>
						</span>
						</div>
					</div>		
				</form>
